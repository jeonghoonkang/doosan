...
def migrate_current(db, nodeid):
	for ty in ['a', 'b', 'c']:
		...
		url = "http://125.7.128.52:4242/api/query?start=%s&m=avg:gyu_RC1_etype.current_%s{nodeid=%s}" % (start, ty, nodeid)
...
def migrate_voltage(db, nodeid):
	for ty in ['a', 'b', 'c']:
		...
		url = "http://125.7.128.52:4242/api/query?start=%s&m=avg:gyu_RC1_etype.voltage_%s{nodeid=%s}" % (start, ty, nodeid)
...
if __name__ == '__main__':
	...
	while True:
		...
		updateMerge(db, "usage.kWh.all", [ "usage.kWh.2701", "usage.kWh.2702", "usage.kWh.2703", "usage.kWh.2704", "usage.kWh.2705" ], start_sec)
		updateMerge(db, "diff.1d.usage.kWh.all", [ "diff.1d.usage.kWh.2701", "diff.1d.usage.kWh.2702", "diff.1d.usage.kWh.2703", "diff.1d.usage.kWh.2704", "diff.1d.usage.kWh.2705" ], start_sec)
		updateMerge(db, "diff.1h.usage.kWh.all", [ "diff.1h.usage.kWh.2701", "diff.1h.usage.kWh.2702", "diff.1h.usage.kWh.2703", "diff.1h.usage.kWh.2704", "diff.1h.usage.kWh.2705" ], start_sec)
		updateMerge(db, "diff.15m.usage.kWh.all", [ "diff.15m.usage.kWh.2701", "diff.15m.usage.kWh.2702", "diff.15m.usage.kWh.2703", "diff.15m.usage.kWh.2704", "diff.15m.usage.kWh.2705" ], start_sec)
		updateMerge(db, "diff.5m.usage.kWh.all", [ "diff.5m.usage.kWh.2701", "diff.5m.usage.kWh.2702", "diff.5m.usage.kWh.2703", "diff.5m.usage.kWh.2704", "diff.5m.usage.kWh.2705" ], start_sec)
